...
// mysql dadtabase connection
const db = mysql.createPool({
host: process.env.MYHOST,               // host name
user: process.env.MYUSER,               // database user
password: process.env.PASSWORD,         // database user password
...
console.log(`--------------heyyy-----------${process.env.MYUSER}`);
...
const port_frontend = process.env.PORTFRONTEND
 ...
 app.use(cors({credentials: true,
    origin: [`http://myapp.com`,`https://myapp.com`,'http://localhost:5000','http://localhost:5001','http://localhost','http://server:5000'],
